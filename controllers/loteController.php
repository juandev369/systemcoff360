...
function redirigirLotes()
{
    header('Location: ../views/dashboard/lotes.php');
    exit;
}

function redirigirDetalle($id_lote)
{
...
if ($accion === 'actualizar') {
    ...
    $resultado = $loteModel->actualizar($id_lote, [
        'nombre' => $nombre,
        'ubicacion' => $ubicacion,
        'tipo_plantacion' => $tipo_plantacion,
        'area_hectareas' => $area_hectareas,
...
if ($accion === 'cambiarEstado') {
    ...
    $resultado = $loteModel->cambiarEstado($id_lote, $nuevoEstado);
...
if ($accion === 'registrarActividad') {
    ...
    if ($id_lote <= 0 || $tipo === '' || $fecha === '' || $id_responsable <= 0) {
        ...
        redirigirDetalle($id_lote);
    }

    $resultado = $loteModel->registrarActividad([
        'id_lote' => $id_lote,
